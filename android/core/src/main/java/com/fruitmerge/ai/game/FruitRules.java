...
public final class FruitRules {
    ...
    public static final int SPAWN_MAX_LEVEL = 5;
    ...
    public static final float DROP_INITIAL_VELOCITY_Y = 80f;
    public static final float STABLE_VELOCITY_PIXELS_PER_SECOND = 35f;
    public static final float STABLE_ANGULAR_VELOCITY = 4f;
    public static final int PHYSICS_FPS = 120;
    public static final int STABLE_FRAMES = 15;
    public static final int MAX_PHYSICS_FRAMES_PER_DROP = 720;
    public static final int DANGER_FRAMES = 2 * PHYSICS_FPS;
    public static final float STABLE_WINDOW_SECONDS =
            STABLE_FRAMES / (float) PHYSICS_FPS;
    public static final float DANGER_SECONDS =
            DANGER_FRAMES / (float) PHYSICS_FPS;
    ...
    public static int mergeScoreForSource(int sourceLevel) {
        requireLevel(sourceLevel);
        return sourceLevel * (sourceLevel + 1) / 2;
    }
    ...
    public static float actionDropX(int actionIndex, int level) {
        ...
        float left = WALL_WIDTH + radius + 2f;
        float right = BOARD_WIDTH - WALL_WIDTH - radius - 2f;
        float normalized = actionIndex / (ACTION_COUNT - 1f);
