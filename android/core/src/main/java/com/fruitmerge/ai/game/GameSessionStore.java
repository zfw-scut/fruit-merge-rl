...
public final class GameSessionStore {
    ...
    private static void writeSingleState(
        ...
        output.writeInt(state.physicsFramesSinceDrop);
    ...
    private static void validateSingleState(SingleState state) {
        ...
        if (state.physicsFramesSinceDrop < 0
                || state.physicsFramesSinceDrop
                > FruitRules.MAX_PHYSICS_FRAMES_PER_DROP) {
            throw new IllegalArgumentException(
                    "physicsFramesSinceDrop is out of range"
            );
        }
    ...
    public static final class SingleState {
        ...
        private final int physicsFramesSinceDrop;
        ...
        public SingleState(
            ...
            this.physicsFramesSinceDrop = physicsFramesSinceDrop;
        ...
        public int physicsFramesSinceDrop() {
            return physicsFramesSinceDrop;
        }
