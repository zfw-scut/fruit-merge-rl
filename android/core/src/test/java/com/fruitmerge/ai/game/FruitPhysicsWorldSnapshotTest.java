...
/**
 * FruitPhysicsWorld 存档契约的真实 Box2D 测试。
 *
 * <p>测试运行时加载 desktop Box2D natives，覆盖的不是 DTO 自身复制，而是销毁、
 * 重建真实刚体后的位置、速度、半径和后续接触回调。</p>
 */
public final class FruitPhysicsWorldSnapshotTest {
    ...
    @Test
    public void restoredBodiesContinueThroughRealBox2dMerge() {
