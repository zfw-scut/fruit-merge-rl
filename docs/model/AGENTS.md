...
| 类别 | 文档 | 含义 |
| --- | --- | --- |
| 当前实现基础 | `ACTION_CONDITIONED_EFFECT_VIEW.md`、`AUXILIARY_ACTION_EFFECT_LEARNING.md`、`TRAINING_DATA_EXTENSION_ARCHITECTURE.md`、`MERGE_DISTANCE_PREDICTOR.md` | 部分或全部已实现；最新效果仍看评估报告 |
