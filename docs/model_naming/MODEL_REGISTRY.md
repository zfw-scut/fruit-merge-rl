...
| 短称 | 正式ID | 关键区分 | 状态 | 配置 |
| --- | --- | --- | --- | --- |
| `SAB-FF30-E18` | `sab-full-fall-edge18-128m-b16m-r1` | 从零训练；30 FPS完整逐帧、18维水果边、128M父轨迹和16,777,216旁路；SAB-128仅作预热teacher | 待云端标定与训练 | [`../../configs/sab-full-fall-edge18-128m-b16m-r1.toml`](../../configs/sab-full-fall-edge18-128m-b16m-r1.toml) |
